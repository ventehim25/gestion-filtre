...
('Filtre huile Filtron — Citroën Xsara Picasso',        'فلتر زيت فيلترون — سيتروين خيسارا', 'OP629/3',   'filtre_huile', 17, 28,  8, 3),
...
('Filtre huile Filtron — BMW Série 3 316/318/320d',     'فلتر زيت فيلترون — بي إم دبليو 3',  'OP592/2',   'filtre_huile', 21, 36,  8, 3),
('Filtre huile Filtron — BMW Série 5 520/525d',         'فلتر زيت فيلترون — بي إم دبليو 5',  'OP592/3',   'filtre_huile', 22, 38,  6, 3),
...
('Filtre huile Filtron — Opel Astra 1.7/1.9 CDTi',     'فلتر زيت فيلترون — أوبل أسترا',    'OP641/5B',  'filtre_huile', 18, 30,  8, 3),
('Filtre huile Filtron — Opel Corsa 1.3/1.7 CDTi',     'فلتر زيت فيلترون — أوبل كورسا',    'OP641/6B',  'filtre_huile', 17, 28,  8, 3),
...
-- FILTRON — FILTRES CARBURANT
insert into public.products (nom_fr, nom_ar, reference, categorie, prix_achat, prix_vente, stock, stock_min) values
('Filtre carburant Filtron — Renault/Dacia 1.5 dCi',        'فلتر بنزين فيلترون — رينو داسيا 1.5',   'PP839',     'filtre_carburant', 20, 35, 12, 3),
...
('Filtre carburant Filtron — VW Polo/Caddy 1.4/1.9 TDI',   'فلتر بنزين فيلترون — فولكسفاغن بولو',   'PP996/1',   'filtre_carburant', 19, 33,  8, 3),
